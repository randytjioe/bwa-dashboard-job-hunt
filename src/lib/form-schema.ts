import { TextWatcherMatchedSelectionEvent } from "./../../node_modules/@ckeditor/ckeditor5-typing/src/textwatcher.d";
...
export const jobFormSchema = z.object({
  ...
  requiredSkills: z.string().array().nonempty({
    message: "Required Skill must be at least 1 skill",
  }),
  jobDescription: z
  ...
  niceToHaves: z
    .string({ required_error: "Nice To Haces is required" })
    .min(10, { message: "Nice To Haces must be at least 10 characters" }),
  benefits: z
